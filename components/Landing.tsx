...
<div>
    ...
    <div className="grid gap-4 lg:grid-cols-3 justify-center">
      <ArticleCard
        title="EarnStake Features"
        href="/"
        description="Learn about EarnStake more"
      />

      <ArticleCard
        title="Capabalities and Uses"
        href="/"
        description="EarnStake provides a vast variety of uses cases specifically for education"
      />

      <ArticleCard
        title="EarnStake Dashboard"
        href="/"
